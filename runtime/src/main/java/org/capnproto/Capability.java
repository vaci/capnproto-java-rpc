...
public final class Capability {
    ...
    public interface ClientBase {
        ...
        /**
         * If the capability's server implemented Server.getFd returning non-null, and all
        ...
        default CompletableFuture<FileDescriptor> getFd() {
            FileDescriptor fd = this.getHook().getFd();
            if (fd != null) {
                return CompletableFuture.completedFuture(fd);
            }
            CompletableFuture<ClientHook> promise = this.getHook().whenMoreResolved();
            if (promise != null) {
        ...
        default <T> Request<T> newCall(FromPointerBuilder<T> paramsFactory, long interfaceId, short methodId) {
            Request<AnyPointer.Builder> request = this.getHook().newCall(interfaceId, methodId);
        ...
        default <T> StreamingRequest<T> newStreamingCall(FromPointerBuilder<T> paramsFactory, long interfaceId, short methodId) {
            Request<AnyPointer.Builder> request =  this.getHook().newCall(interfaceId, methodId);
            StreamingRequest<AnyPointer.Builder> streamingRequest = newTypelessStreamingRequest(request.getParams(), request.getHook());
            return new StreamingRequest<T>() {
                @Override
                public FromPointerBuilder<T> getParamsFactory() {
                    return paramsFactory;
                }
    ...
    public abstract static class Server {
        ...
        private final class LocalClient<T extends Server> implements ClientHook {
            ...
            LocalClient(CapabilityServerSet<T> capServerSet) {
                ...
                CompletableFuture<Capability.Client> resolveTask = shortenPath();
                if (resolveTask != null) {
            ...
            public Request<AnyPointer.Builder> newCall(long interfaceId, short methodId) {
                LocalRequest hook = new LocalRequest(interfaceId, methodId, this);
                AnyPointer.Builder root = hook.message.getRoot(AnyPointer.factory);
            ...
            public VoidPromiseAndPipeline call(long interfaceId, short methodId, CallContextHook ctx) {
                ...
                CompletableFuture<java.lang.Void> promise = ctx.releaseCall().thenCompose(void_ -> {
                    if (blocked) {
                        CompletableFuture<java.lang.Void> blockedCall = new CompletableFuture<java.lang.Void>();
                ...
                CompletableFuture<PipelineHook> tailCall = ctx.onTailCall().thenApply(pipeline -> pipeline.hook);
            ...
            void unblock() {
                ...
                while (!this.blocked) {
                    ...
                    Runnable call = this.blockedCalls.remove();
                    call.run();
                }
            }
            ...
            CompletableFuture<java.lang.Void> callInternal(long interfaceId, short methodId, CallContextHook ctx) {
                ...
                if (this.brokenException != null) {
                    CompletableFuture<java.lang.Void> result = new CompletableFuture<>();
                    result.completeExceptionally(this.brokenException);
                    return result;
                }

                DispatchCallResult result = dispatchCall(
        ...
        */
        ...
        protected static CompletableFuture<java.lang.Void> internalUnimplemented(String actualInterfaceName, long requestedTypeId) {
            CompletableFuture<java.lang.Void> result = new CompletableFuture<>();
            result.completeExceptionally(RpcException.unimplemented(
    ...
    private static class LocalRequest implements RequestHook {
        ...
        public RemotePromise<AnyPointer.Reader> send() {
            CompletableFuture cancel = new CompletableFuture<java.lang.Void>();
            LocalCallContext context = new LocalCallContext(message, client, cancel, this.callRelease);
            ClientHook.VoidPromiseAndPipeline promiseAndPipeline = client.call(interfaceId, methodId, context);
            CompletableFuture promise = promiseAndPipeline.promise.thenApply(x -> {
    ...
    private static class LocalCallContext implements CallContextHook {
        ...
        public AnyPointer.Builder getResults(int sizeHint) {
            if (this.response == null) {
                LocalResponse localResponse = new LocalResponse(sizeHint);
        ...
        public CompletableFuture<java.lang.Void> tailCall(RequestHook request) {
            ClientHook.VoidPromiseAndPipeline result = this.directTailCall(request);
        ...
        public CompletableFuture<AnyPointer.Pipeline> onTailCall() {
            ...
            return this.tailCallPipeline.thenApply(x -> x);
        }
        ...
        public ClientHook.VoidPromiseAndPipeline directTailCall(RequestHook request) {
            ...
            RemotePromise<AnyPointer.Reader> promise = request.send();
            CompletableFuture voidPromise = promise.response.thenAccept(tailResponse -> {
    ...
    static Request<AnyPointer.Builder> newTypelessRequest(AnyPointer.Builder params, RequestHook requestHook) {
        return new Request<AnyPointer.Builder>() {
            @Override
    ...
    static StreamingRequest<AnyPointer.Builder> newTypelessStreamingRequest(AnyPointer.Builder params, RequestHook requestHook) {
        return new StreamingRequest<AnyPointer.Builder>() {
            @Override
            public AnyPointer.Builder getParams() {
                return params;
            }
    ...
    static Request<AnyPointer.Builder> newBrokenRequest(Throwable exc) {
        ...
        AnyPointer.Builder params = message.getRoot(AnyPointer.factory);

        RequestHook hook = new RequestHook() {
            @Override
            public RemotePromise<AnyPointer.Reader> send() {
                CompletableFuture<Response<AnyPointer.Reader>> promise = new CompletableFuture<>();
                promise.completeExceptionally(exc);
                return new RemotePromise<>(promise, newBrokenPipeline(exc));
            }
    ...
    private static ClientHook newBrokenClient(Throwable exc, boolean resolved, Object brand) {
        return new ClientHook() {
            ...
            public VoidPromiseAndPipeline call(long interfaceId, short methodId, CallContextHook context) {
                CompletableFuture<java.lang.Void> promise = new CompletableFuture<>();
                promise.completeExceptionally(exc);
                return new VoidPromiseAndPipeline(promise, newBrokenPipeline(exc));
            }
            ...
            public CompletableFuture<ClientHook> whenMoreResolved() {
                if (resolved) {
                    ...
                    CompletableFuture<ClientHook> promise = new CompletableFuture<>();
                    promise.completeExceptionally(exc);
                    return promise;
                }
            }
    ...
    private static final class QueuedPipeline implements PipelineHook {
        ...
        public final ClientHook getPipelinedCap(short[] ops) {
            ...
            ArrayList<Short> key = new ArrayList<Short>(ops.length);
            for (short op: ops) {
                key.add(op);
            }
    ...
    private static class QueuedClient implements ClientHook {
        ...
        QueuedClient(CompletableFuture<ClientHook> promise) {
            this.selfResolutionOp = promise.handle((inner, exc) -> {
                ...
                for (CompletableFuture<ClientHook> call: this.queuedCalls) {
                ...
                for (Capability.LocalRequest hook: this.pendingCalls) {
                    hook.releaseCall();
                }
        ...
        public VoidPromiseAndPipeline call(long interfaceId, short methodId, CallContextHook ctx) {
            ...
            CompletableFuture<ClientHook> promise = new CompletableFuture<>();
            CompletableFuture<VoidPromiseAndPipeline> callResult = promise.thenApply(
                    client -> client.call(interfaceId, methodId, ctx));
            CompletableFuture<PipelineHook> pipelineResult = callResult.thenApply(result -> result.pipeline);
            QueuedPipeline pipeline = new QueuedPipeline(pipelineResult);
        ...
        @Override
        public CompletableFuture<ClientHook> whenMoreResolved() {
            return this.promiseForClientResolution.thenApply(x -> x);
        }
    ...
    public static final class CapabilityServerSet<T extends Capability.Server> {
        ...
        CompletableFuture<T> getLocalServerInternal(ClientHook hook) {
            for (;;) {
                ClientHook next = hook.getResolved();
                if (next != null) {
                    hook = next;
                }
                else {
            ...
            if (hook.getBrand() == Server.BRAND) {
                CompletableFuture<T> promise = ((Server.LocalClient<T>)hook).getLocalServer(this);
                if (promise != null) {
                    return promise;
                }
            }
            ...
            CompletableFuture<ClientHook> resolver = hook.whenMoreResolved();
            if (resolver != null) {
        ...
        <U extends Capability.Client> U add(Capability.Factory<U> factory, T server) {
            ClientHook hook = this.addInternal(server);
