...
public final class CallContext<Params, Results> {
    ...
    private final FromPointerReader<? extends Params> paramsFactory;
    private final FromPointerBuilder<? extends Results> resultsFactory;
    private final CallContextHook hook;

    public CallContext(FromPointerReader<? extends Params> paramsFactory,
                FromPointerBuilder<? extends Results> resultsFactory,
